...
* tasks:
  ...
  * id: P1.W1.T4.1
    ...
    context_files: ["phases/01_LegacyDB/PLANNING_PHASE1.md#Testing-Strategy-for-00_setup_databases.py", ".windsurf/instructions/guide-python-testing.md", ".windsurf/instructions/guide-python-style.md"]
