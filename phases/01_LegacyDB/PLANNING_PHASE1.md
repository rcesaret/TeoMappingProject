...
## Phase 1 of the Digital TMP Project: Purpose & Architectural Philosophy

### Purpose and Core Objective of Phase 1
...
### Architectural Philosophy Guiding Phase 1 Workflows
...
## Phase 1 Architectural Overview & Workflows

### The Four Workflows of Phase 1
...
## Master Execution Plan: From Setup to Synthesis
...
### Stage 1: Final Environment Setup & Verification
...
#### Verify `config.ini` Configuration
...
#### Verify External Dependencies (Graphviz)
...
#### Populate and Verify Canonical Queries
...
### Stage 2: Data Ingestion & Preparation
...
#### Execute Legacy Database Setup Script
...
#### Execute Benchmark Database Creation Script
...
### Stage 4: Aggregation & Summary Reporting
...
#### Execute Comparative Analysis Notebook
...
#### Finalize `Phase1_WhitePaper_v3.md`
...
## Detailed Task Protocols & Validation Procedures
...
### Task 1.2: Execution and Validation of `src/00_setup_databases.py`

The complete revised script for `src/00_setup_databases.py` is already drafted.

#### **Completing Task 1.2: Notes on Testing and Validation**
...
* For the first run, you should see messages like "Database 'TMP_DF8' created successfully." followed by "Successfully populated database 'TMP_DF8'." for each of the four databases.
...
* Run the script a second time from the `src` directory:
    ...
    python 00_setup_databases.py
    ```
- **Expected Output**: This time, the log messages should be different. You should see "Database 'TMP_DF8' already exists. Skipping creation." for each database. The script should still execute the population step but should complete without any errors. This proves the script is robust and safely re-runnable.

---

### Task 1.3: Execution and Validation of `src/01_create_benchmark_dbs.py`
...
#### **Files associated with Task 1.3**
...
##### **`sql/flatten_df9_text_nulls.sql` (Revised)**

This query joins the 18 core data tables from the tmp_df9 schema into a single wide-format table. It uses LEFT JOINs from the central "tblSSN" table to ensure all site records are preserved.
...
1. Coded values (integers) are replaced with their corresponding text descriptions by joining the appropriate 'Codes_' lookup tables.
...
#### **Completing Task 1.3: Notes for IDE Agent (Revised & Expanded)**
...
##### Validation Procedures for Benchmark Databases
...
##### Testing Strategy for `01_create_benchmark_dbs.py`
...
##### **Foresight & Downstream Considerations** 🧠
...
### Task 2.1: Implement Profiling Modules
...
#### **Files associated with Task 2.1**
...
**1. `src/profiling_modules/__init__.py`**
...
**2. `src/profiling_modules/base.py`**
...
**5. `src/profiling_modules/metrics_profile.py`**
...
**6. `src/profiling_modules/metrics_interop.py`**
...
**7. `src/profiling_modules/metrics_performance.py`**
...
#### **Completing Task 2.1: Notes for IDE Agent**

##### Objective and File Placement Verification
...
##### Testing Strategy for Profiling Modules
...
### Task 2.2: Develop the Profiling Pipeline Orchestrator
...
#### **Completing Task 2.2: Notes for IDE Agent**
...
##### Validation Procedures for Metric Outputs 🕵️
1.  **Log File Review**:
...
##### Testing Strategy for Profiling Pipeline Orchestrator 🤖
...
### Task 2.3: Refine the ERD Generation Script
...
##### **`src/03_generate_erds.py` (Revised)**
...
#### **Completing Task 2.3: Notes for IDE Agent**
...
##### **`src/04_run_comparison.py` (Revised)**
...
#### **Completing Task 3.1: Notes for IDE Agent**
...
#### **Notebook Template: `template_individual_db_analysis.ipynb`**
...
#### **Completing Task 4.1a Notes for IDE Agent**
...
#### **Notebook Template: `template_comparative_analysis.ipynb`**
...
#### **Completing Task 4.2: Notes for IDE Agent**
...
3.  **Qualitative Table**: Confirm the markdown table for architectural trade-offs renders correctly.
4.  **Analyst Summary**: Verify the final markdown cell renders with the detailed template, ready for the analyst to fill in.
...
## 6.0 Strategic Project Guidance
...
#### Workflow 1: Foundation & Environment Setup
...
#### Workflow 2: Profiling & Visualization Tooling
...
#### Workflow 3: Aggregation and Reporting
- **Task 3.1: Develop `04_run_comparison.py`**.
...
#### Workflow 4: Analysis and Synthesis
- **Task 4.1: Develop Individual Database Analysis Notebook Template**.
