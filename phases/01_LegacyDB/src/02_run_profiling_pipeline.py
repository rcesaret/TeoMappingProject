...
def save_results(
    ...
    try:
        ...
        logging.info(
            f"Successfully saved '{metric_name}' results to {output_path.name}"
        )
    except Exception as e:
...
def main() -> None:
    ...
    for i, db_name in enumerate(all_dbs_to_profile, 1):
        ...
        try:
            ...
            logging.error(
                f"CRITICAL ERROR in Basic DB Metrics for '{db_name}': {e}",
                exc_info=True,
            )
        ...
        try:
            ...
            logging.error(
                f"CRITICAL ERROR in Schema Object Counts for '{db_name}': {e}",
                exc_info=True,
            )
        ...
        try:
            ...
            logging.error(
                f"CRITICAL ERROR in Table Level Metrics for '{db_name}': {e}",
                exc_info=True,
            )
        ...
        try:
            ...
            logging.error(
                f"CRITICAL ERROR in Column Structural Metrics for '{db_name}': {e}",
                exc_info=True,
            )
        ...
        try:
            ...
            logging.error(
                f"CRITICAL ERROR in Column Data Profiles for '{db_name}': {e}",
                exc_info=True,
            )
        ...
        try:
            ...
            logging.error(
                f"CRITICAL ERROR in Interoperability Metrics for '{db_name}': {e}",
                exc_info=True,
            )
        ...
        try:
            ...
            logging.error(
                f"CRITICAL ERROR in Performance Benchmarks for '{db_name}': {e}",
                exc_info=True,
            )
